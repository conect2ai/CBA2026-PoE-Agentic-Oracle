...
```bibtex
@inproceedings{amaral2026poe,
  title={PoE-Oracle: Um Sistema Multiagente com Blockchain para Auditoria Autônoma de Créditos de Carbono Baseados em Telemetria Veicular},
  author={Amaral, Miguel and Silva, Marianne and Silva, Ivanovitch},
  booktitle={Anais do CBA 2026},
  year={2026},
